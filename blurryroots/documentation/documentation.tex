...
\part[Bekämpfung]{Geldwäschebekämpfung}
    ...
    \section[Beschreibung]{Beschreibung}
        ...
        Im Wesentlichenen gliedert sich die Bekämpfung in drei Ebenen. Die erste ist die Vorsorge bzw. Sorgfalt des mit dem Geld handelnden Instituts. Sollte der Verantwortliche nicht in der Lage sein, allen Punkten nachzukommen, ist die Geschäftsbeziehung unverzüglich zu beenden bzw. nicht einzugehen. Das zweite ist die durchgehende Dokumentation und das Archivieren der Transaktionen sowie Dokumente. Im letzten Schritt ist dann die Zusammenarbeit mit den Überprüfenden Institutionen, welche für die Überprüfung und Ermittlung von Geldwäschefällen verantwortlich sind, zu nennen.
