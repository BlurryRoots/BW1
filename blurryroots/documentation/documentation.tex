...
\part[Geldwäsche]{Geldwäsche}
    ...
    \section[Was ist Geldwäsche?]{Was ist Geldwäsche?}
        ...
        \subsection[Beispiel]{Beispiel}
            ...
            \cite{GoldItalien}
            Viele neu Goldhändler (einige kontrolliert von der Mafia) und Hinterhofgießerein und gründeten sich.
            Wenn nun eine Familie ihr Gold im Wert von 1000 Euro zum Händler bringt kann dieser ihr (gegen prozentualen Anteil)eine Quittung über 2000 Euro ausstellen. So entsteht für ihn (den Händler) ein Spielraum von knapp 1000 Euro um illegal erwirtschaftete Gelder mit in die Bücher des Geschäfts zu bringen.
...
\newpage
    ...
    \begin{thebibliography}{9}
        ...
        \bibitem [1] {GoldItalien} \url{http://deutsche-wirtschafts-nachrichten.de/2012/08/20/wegen-krise-zahl-der-geschaefte-fuer-goldankaeufe-in-italien-hat-sich-vervierfacht/}

        \bibitem [2] {Tätigkeitsbericht} \url{http://www.sachsen-anhalt.de/index.php?id=20023}

        \bibitem [3] {EUZeugs} \url{http://www.wdr.de/tv/monitor/sendungen/2012/0908/pdf/geldwaesche.pdf}

        \bibitem [4] {Beatmin} Britt Paulsen, Verwaltungsbeamtin

        \bibitem [Wikipedia: BaFin] {bafin} \url{https://de.wikipedia.org/wiki/Bundesanstalt_f%C3%BCr_Finanzdienstleistungsaufsicht}

        \bibitem [Gesetz: GwG] {GwG} \url{http://www.gesetze-im-internet.de/gwg_2008/BJNR169010008.html}
